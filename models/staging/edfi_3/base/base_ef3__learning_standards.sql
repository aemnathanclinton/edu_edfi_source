...
renamed as (
    select
        ...
        {{ jget('v:identificationCodes::string') }}                     as v_learning_standard_identification_codes,
        -- descriptions
        ...
        {{ jget('v:prerequisiteLearningStandards::string') }}           as v_prerequisite_learning_standards,
