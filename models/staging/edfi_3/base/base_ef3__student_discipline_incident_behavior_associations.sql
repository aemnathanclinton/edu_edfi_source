...
renamed as (
    select
        ...
        {{ jget("v:behaviorDetailedDescription::string") }}                    as behavior_detailed_description,
        -- descriptors
        ...
        -- lists
        {{ jget("v:disciplineIncidentParticipationCodes::string") }} as v_discipline_incident_participation_codes,
